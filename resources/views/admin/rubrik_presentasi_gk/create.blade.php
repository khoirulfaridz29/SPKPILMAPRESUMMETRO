...
@section('title', 'Tambah Rubrik Presentasi GK')

@section('content')
<div class="card">
    <div class="card-header">
        <i class="fa-solid fa-plus me-2"></i> Tambah Kriteria Rubrik Presentasi GK
    </div>
    <div class="card-body">
        <form action="{{ route('admin.rubrik-presentasi-gk.store') }}" method="POST">
            @csrf
            <div class="mb-3">
