    ...
    <div class="card-body p-4">
        <form action="{{ route('admin.panduan.update', $panduan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul', $panduan->judul) }}" required>
                @error('judul')
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $panduan->deskripsi) }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                @endif
                <input type="file" name="file_panduan" class="form-control @error('file_panduan') is-invalid @enderror" accept=".pdf">
